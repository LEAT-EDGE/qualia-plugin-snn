...
from qualia_core.learningmodel.pytorch.layers.Add import Add as QualiaCoreAdd
...
class Add(QualiaCoreAdd,
    ...
    def extra_repr(self) -> str:
        ...
        :return: String representation of :class:`qualia_core.learningmodel.pytorch.layers.Add` with ``step_mode``.
        """
        return super().extra_repr() + f', step_mode={self.step_mode}'

    @override
    def forward(self, a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
        """Forward :class:`qualia_core.learningmodel.pytorch.layers.Add` with ``step_mode`` support.
